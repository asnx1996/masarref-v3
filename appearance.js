...
const APPEARANCE_THEMES = {
  ...
  midnight: { name:'منتصف الليل', en:'Midnight', note:'كحلي عميق وإضاءة زرقاء', noteEn:'Deep navy, soft blue', background:'glow' },
...
const APPEARANCE_BACKGROUNDS = {
  ...
  curves: ['انحناءات', 'Curves'], landscape: ['الشمس والجبال', 'Landscape']
};
...
function appearanceSettings(){
  ...
  return `<section class="appearance-settings" aria-labelledby="appearanceTitle">
    ...
    ${Object.entries(APPEARANCE_THEMES).map(([id,t]) => `<button type="button" class="theme-choice" data-theme-choice="${id}" aria-pressed="${theme===id}">
